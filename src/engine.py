...
# 📌 Assure-toi que le chemin correspond à ton installation de Stockfish
stockfish_path = "D:/Vincent/- Informatique -/Echecs OpenAi/stockfish/stockfish-windows-x86-64-avx2.exe"
